...
For forms, I use React 19 features like Server Actions and `useActionState`. I’ll also use Zod to validate objects inside my actions. [Here's one example](https://github.com/GELLIFY/acme-app) of this pattern.
...
Postgres is my go-to database. Drizzle makes working with Postgres easy, type-safe, and fun. I can view and modify my data using Drizzle Studio and [run migrations](https://github.com/GELLIFY/acme-app) with Drizzle Kit.
