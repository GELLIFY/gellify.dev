  ...
  return (
    <main className="container flex flex-col items-center py-16 text-center z-[2]">
      ...
      <p className="text-fd-muted-foreground">
        You can start with the Fullstack or Enterprise Template.
      </p>
      <div className="mt-4 grid grid-cols-2 gap-4">
        <a
          href="https://github.com/GELLIFY"
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 text-left md:grid-cols-2">
        <Item href="/docs/fullstack">
          <Icon>
            <Building2 className="size-full" />
          </Icon>
          <h2 className="mb-2 text-lg font-semibold">Fullstack Template</h2>
        ...
        <Item href="/docs/headless">
          ...
          <h2 className="mb-2 text-lg font-semibold">Enterprise Template</h2>
          <p className="text-sm text-fd-muted-foreground">
